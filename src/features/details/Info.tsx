...
import { loadNeighborsByBorders, selectNeighbors } from './detailsSlice';
import { CountryInfo } from '../countries/countriesSlice';
...
interface InfoProps extends CountryInfo {
